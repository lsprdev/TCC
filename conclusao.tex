...
Este projeto de TCC propõe o desenvolvimento e a avaliação de um fluxo padronizado para extração estruturada de informações em provas objetivas manuscritas. O foco está na comparação entre dois modelos multimodais acessados por APIs: um modelo aberto e um modelo proprietário. O aplicativo móvel será utilizado apenas para captura das imagens e visualização dos resultados, enquanto o processamento será realizado pelo backend e pelas APIs dos modelos avaliados.
