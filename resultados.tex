...
O protótipo será submetido a testes de campo com os orientadores do projeto, que atuam como usuários especialistas. Serão realizados experimentos de processamento de lotes de provas para medir a precisão técnica e a utilidade percebida. Esta fase utilizará o Framework for Evaluation in Design Science (FEDS), alternando entre avaliações formativas (durante o desenvolvimento) e sumativas (ao final do ciclo).
