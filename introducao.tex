...
\begin{itemize}
    ...
    \item Desenvolver um mecanismo de "Saída Estruturada" (Structured JSON) que converta a percepção visual da IA em dados computáveis, minimizando a necessidade de pós-processamento de texto \cite{google_structured_outputs2026}.
