...
\begin{enumerate}
    ...
    \item \textbf{Camada modular de IA}: componente \textit{ModelAdapter} que normaliza a comunicação com um \textit{OpenModelProvider}, hospedado em servidor próprio, e um \textit{ClosedModelProvider}, acessado por API externa.
\end{enumerate}
