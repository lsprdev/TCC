...
% Índice remissivo (necessário para \printindex)
\usepackage{makeidx}
\makeindex
...
\preambulo{Trabalho de conclusão de curso apresentado como requisito parcial para a obtenção do grau de Bacharel em Sistemas de Informação Instituto Federal Catarinense.}
