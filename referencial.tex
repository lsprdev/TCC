...
Arquiteturas pluváveis buscam separar a regra de negócio das implementações concretas de componentes substituíveis. No caso deste trabalho, o componente substituível é o provedor de IA. A aplicação não deve depender diretamente de uma API específica, pois isso dificultaria a comparação experimental e a manutenção do sistema quando novos modelos forem testados.
